  ...
  Future<bool> createCart() async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode(<String, String>{
        ...
        'product_id':widget.product.productId.toString(), // เรียก ไอดีของสินค้าออกมากำหนดค่าเป็น String
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          selectedColor = item;
          //print(selectedColor);
          print("สี${item.colorId}"); //$ เป็นการกำหนดเทมเพลส String คือการที่เราสามารถพิมพ์ตัวแปรลงไปในข้อความได้
